...
//print_r($data['amount']);die;
        ...
        if(\Illuminate\Support\Facades\Auth::user()->type == "FLAT_OWNER"){
          $type = "FLAT_OWNER";  
          $flat_owner_id = \Illuminate\Support\Facades\Auth::user()->id;
          $rentee_id = "";
        }else if(\Illuminate\Support\Facades\Auth::user()->type == "RENTEE"){
           $type = "RENTEE";  
          $rentee_id = \Illuminate\Support\Facades\Auth::user()->id; 
          $flat_owner_id = "";
        }

        #Before  going to initiate the payment order status need to update as Pending.
        $update_product = DB::table('sslcmrz_payment_requests')
            ->where('transaction_id', $post_data['tran_id'])
            ->updateOrInsert([               
                'amount' => $post_data['total_amount'],
                'status' => 'Pending',
...
//print_r($payment_options);
    ...
    public function success(Request $request)
    {
        ...
        $order_details = DB::table('sslcmrz_payment_requests')
