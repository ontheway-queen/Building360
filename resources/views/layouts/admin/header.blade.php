      ...
      <div class="container-fluid">
        <nav class="navbar">
          ...
          <div class="d-flex">
            ...
            <span class="brand-icon d-flex align-items-center mx-2 mx-sm-3 text-primary">Wellcome, {{Auth::user()->name}}!!</span>
          </div>
          <!-- start: search area -->
          <div class="header-left flex-grow-1 d-none d-md-block">
            <div class="main-search px-3 flex-fill">
              ...
              <div class="dropdown morphing scale-left notifications">
                ...
                <div id="NotificationsDiv" class="dropdown-menu shadow rounded-4 border-0 p-0 m-0">
                  <div class="card w380">
                    ...
                    <ul class="nav nav-tabs tab-card d-flex text-center" role="tablist">
                      <li class="nav-item flex-fill"><a class="nav-link active" data-bs-toggle="tab" href="#Noti-tab-Message" role="tab">Notice</a></li>
...
<!--                      <a class="list-group-item list-group-item-action border-0" href="page-profile.html"><i class="w30 fa fa-user"></i>My Profile</a>
                    ...
                    <a class="btn bg-secondary text-light text-uppercase rounded-0">
                      <form method="POST" action="{{ route('logout') }}">
@csrf
<button type="submit" class="btn m-1 lift btn-animate-7">Sign out</button>
