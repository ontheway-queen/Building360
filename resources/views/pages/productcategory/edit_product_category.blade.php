                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title mb-0">Edit Product Category</h6>
                        </div>
                        <div class="card-body">
                            <form class="row g-3 maskking-form" id="product_category_form">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <span class="float-label">
                                        ...
                                        <label class="form-label" for="TextInput">product_category Name</label>
                                    </span>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <span class="float-label">
                                        ...
                                        <label class="form-label" for="TextInput">product_category Entry ID</label>
                                    </span>
                                </div>
