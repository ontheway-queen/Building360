            ...
            <div class="row g-3 mb-3 align-items-center">
                <div class="col">
                    <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item"><a class="text-secondary" href="javascript:void()">Product Categories</a></li>
                        <li class="breadcrumb-item active" aria-current="page">List of Product Categories</li>
                    </ol>
                </div>
                        ...
                        <table id="myTable" class="table display dataTable table-hover" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>Product Category Entry ID</th>
                                    <th>Action</th>
                                </tr>
                            </thead>
                            <tbody>
