    ...
    @section('content')
        ...
        <form class="row maskking-form" id="money_receipt_form">
            ...
            <input type="hidden" name="type" id="type" value="RENTEE">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-sm-12">
                                            <span class="float-label">
                                                <input type="text" class="form-control form-control-lg" id="searchRentee"
                                                    placeholder="Search Rentee" name="client_name">
                                                <label class="form-label" for="TextInput">Search Rentee</label>
                                            </span>
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-lg-4 col-sm-4">
                                                ...
                                                <select class="form-control form-control-lg custom-select"
                                                    name="payment_method" id="checqueId">
    ...
    <option value="{{ $row->account_id }}">{{ $row->account_name . ', ' . $row->account_number }}</option>
    @endforeach
                                                                    </select>
                                                            </td>-->
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $('#searchRentee').autocomplete({
                    html: true,
                    source: function(request, response) {
                        $.ajax({
                            type: "GET",
                            url: "{{ url('rentee-name-search') }}",
                            dataType: "json",
                            data: {
                                q: request.term,
                            },
                ...
                $('#searchInvoice').autocomplete({
                    ...
                    source: function(request, response) {
                        ...
                        $.ajax({
                            type: "GET",
                            url: "{{ url('search-rentee-wise-invoice') }}/",
                            dataType: "json",
                            data: {
                                q: hiddenId,
                            },
