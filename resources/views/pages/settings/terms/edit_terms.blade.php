   ...
   <div class="col-12">
    <div class="card">
     <div class="card-header">
      <h6 class="card-title mb-0">Edit Terms</h6>
     </div>
     <div class="card-body">
      <form class="row g-3" id="terms_form">
        @method('PUT')
        @csrf
        <input type="hidden" name="terms_id" id="terms_id" value="{{$data->terms_id}}">
       <div class="col-lg-12">
        <label class="form-label">Terms</label>
        <fieldset class="form-icon-group left-icon position-relative">
         <input type="text" class="form-control" id="terms_details" name="terms_details" value="{{$data->terms_details}}">
...
<script type="text/javascript">
    ...
    $("#terms_form").submit(function(e) {
                ...
                let getterms_id = $("[name=terms_id]").val();
                $('#loader').show();
                $.ajax({
                    headers: {
                    ...
                    method: "POST",
                    url: "{{ url('terms') }}/" + $("[name=terms_id]").val(),
                    data: data,
                    cache: false,
                    contentType: false,
                    processData: false,
