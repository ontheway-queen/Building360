                ...
                <div class="card-body">
                    <form id="add_form" autocomplete="off">
                        <div class="row">
                            ...
                            <h3>Your Due Amount is TK.
                                {{ get_flat_owner_current_balance_by_flat_owner_id(Auth::user()->id) }}</h3>
                            <br>
                            <br>
                            <br>
                            <div class="col-lg-3 col-sm-12">
                                <span class="float-label">
                                    ...
                                    <select class="form-control form-control-lg" id="invoice_id" name="invoice_id">
                            ...
                            <div class="col-lg-3 col-sm-12">
                                <span class="float-label">
                                    ...
                                    <input type="hidden" class="form-control form-control-lg" id="hidden_flat_owner_id"
                                        placeholder="Brnach" name="hidden_flat_owner_id" value="{{ Auth::user()->id }}">
                                </span>
                            </div>
