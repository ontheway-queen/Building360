                    ...
                    <table id="myTable" class="table display dataTable table-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="sorting">@if($row->flat_owner_id) {{$user[0]->name}} @endif</td>
                                <td class="sorting">@if($row->rentee_id) {{$user[0]->name}} @endif</td>
                                ...
                                <td class="sorting">
                                              ...
                                              <button data-row="{{$row->id}}" onclick="approvePayment('{{$row->id}}')"  class="btn btn-primary px-4 text-uppercase" type="button">
                      ...
                      <div class="modal-body custom_scroll p-lg-5">
                        <div class="row g-2">
                          ...
                          <div class="col-12">
                            ...
                            <button class="btn btn-lg btn-primary text-uppercase" type="submit">Save Status</button>
                          </div>
                         </form>
                        </div>
                      </div>
