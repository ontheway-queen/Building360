            ...
            <div class="row g-3 mb-3 align-items-center">
                <div class="col">
                    <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item"><a class="text-secondary" href="javascript:void()">Attributes Values</a></li>
                        <li class="breadcrumb-item active" aria-current="page">List of Attributes Values</li>
                    </ol>
                </div>
                <div class="col text-md-end">
                    <a class="btn btn-primary" href="{{ url('attribute-values/create') }}"><i class="fa fa-list me-2"></i>Create
                        Attributes Values</a>
