            ...
            <div class="row g-3 mb-3 align-items-center">
                <div class="col">
                    <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Datewise Purchase Report</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title mb-0">Datewise Purchase Report</h6>
                        </div>
                        <div class="card-body">
                                ...
                                @csrf
                                 <div class="col-lg-3 col-md-3 col-sm-12">
                                                ...
                                                <span class="float-label">
                                                    ...
                                                    <label class="form-label" for="TextInput">Select Warehouse </label>
                                                </span>
    ...
    <script type="text/javascript">
        ...
        $("#search_form").submit(function(e) {
            ...
            $.ajax({
                ...
                method: "POST",
                url: "{{ url('reports/get-datewise-purchase-report') }}",
                data: data,
                cache: false,
                contentType: false,
                processData: false,
