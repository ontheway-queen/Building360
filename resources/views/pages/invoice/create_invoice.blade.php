...
@section('content')
                                    ...
                                    <div class="col-lg-3 col-sm-12">
                                        <span class="float-label">
                                            @if (Auth::user()->type == 'FLAT_OWNER')
                                                <label for="warehouse">Select Rentee</label>
                                                <select class="form-control form-control-lg custom-select" name=""
                                                    id="rentee_id">
                                                    <option selected disabled>Select
                                                    </option>
                                                    @foreach ($rentee as $row)
                                                        {
                                                        <option value="{{ $row->rentee }}">
                                                            {{ get_user_name_by_user_id($row->rentee) }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            @else
                                            ...
                                            <input type="hidden" class="form-control form-control-lg" id="hidden_rentee_id"
                                                placeholder="Brnach" name="hidden_rentee_id" value="">
                                        </span>
                                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#rentee_id').change(function() {
                let rentee_val = $(this).find(":selected").val();


                $('#hidden_rentee_id').val(rentee_val);
                // alert(rentee_val);
            });
