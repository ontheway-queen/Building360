...
@section('content')
    ...
    <script type="text/javascript">
        ...
        //         '  <td><textarea readonly class="qty billing-single-total billing-total billing-total-' +
        //         billing_row +
        //         '" data-row="' + billing_row + '" name="billing_total_' + billing_row +
        //         '" readonly></textarea></td>' +
        //         '<td><div class="delete-wpr"><a class="delete" href="javascript:;" title="Remove row">X Remove</a></div></td>'
        //     ' </tr>' +
        //     '<div style="clear:both"></div>' +
        //     '<span class="remove-flight-row"><i class="fa fa-times"></i></span>' +
        //     '<input type="hidden" name="billing_rows[]" value="' + billing_row + '" />' +
