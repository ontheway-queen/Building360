            ...
            <div class="row g-3 mb-3 align-items-center">
                <div class="col">
                    <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">List of Buildingss</li>
                    </ol>
                </div>
                <div class="col text-md-end">
                    <a class="btn btn-primary" href="{{ url('building/create') }}"><i class="fa fa-list me-2"></i>Create
                        Buildings</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-sm btn-danger"
                                                onclick="deleteNow({{ $building->id }})">Delete</button>
                                        </td>
                                    </tr>
                                @endforeach
