            ...
            <form id="add_form" autocomplete="off">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input placeholder="Enter Default Value" id="flat_no" value="{{$items[0]->flat_no}}" class="form-control" name="flat_no" type="text">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input placeholder="Enter Default Value" value="{{$items[0]->entry_id}}" id="entry_id" class="form-control" name="entry_id" type="text">
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input placeholder="Enter Default Value" id="house_no" value="{{$items[0]->house_no}}" class="form-control" name="house_no" type="text">
                    </div>
                    
                     <div class="form-group col-md-6">
                        <label for="field_default_value">Road No.</label>
                        <input placeholder="Enter Default Value" id="road_no" value="{{$items[0]->road_no}}" class="form-control" name="road_no" type="text">
                    </div>
                    
                    <div class="form-group col-md-6">
                        <label for="field_default_value">Description.</label>
                        <input placeholder="Enter Default Value" id="description" value="{{$items[0]->description}}" class="form-control" name="description" type="text">
                    </div>
